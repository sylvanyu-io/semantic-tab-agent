...
const UI_COPY = Object.freeze({
  "zh-CN": {
    ...
    "status.recapAiUnavailable": "已先生成本机回顾；AI 增强可稍后重试。",
    ...
    "recap.evidenceFallback": "本次先使用本机线索生成；AI 增强可稍后重试。",
    "recap.evidencePages": "代表页面：",
    "recap.localFallback": "已先用本机线索生成回顾。",
    "recap.findTab": "定位",
  ...
  "en-US": {
    ...
    "status.recapAiUnavailable": "Local recap is ready. You can retry AI enhancement later.",
    ...
    "cleanup.preview.title": "Check first",
    ...
    "recap.evidenceFallback": "This recap uses local signals for now. You can retry AI enhancement later.",
    "recap.evidencePages": "Representative pages:",
    "recap.localFallback": "Generated from local signals for now.",
    "recap.findTab": "Find",
